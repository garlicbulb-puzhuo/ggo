...
def get_model(input_shape=(1, 128, 128), dropout_prob=0.5):
    ...
    BN1 = BatchNormalization(axis=get_axis())(conv1)
    conv1 = Convolution2D(32, 3, 3, activation='relu',
    ...
    BN2 = BatchNormalization(axis=get_axis())(conv2)
    conv2 = Convolution2D(64, 3, 3, activation='relu',
    ...
    BN3 = BatchNormalization(axis=get_axis())(conv3)
    conv3 = Convolution2D(128, 3, 3, activation='relu',
    ...
    BN4 = BatchNormalization(axis=get_axis())(conv4)
    conv4 = Convolution2D(256, 3, 3, activation='relu',
    ...
    BN5 = BatchNormalization(axis=get_axis())(conv5)
    conv5 = Convolution2D(512, 3, 3, activation='relu',
    ...
    BN6 = BatchNormalization(axis=get_axis())(conv6)
    conv6 = Convolution2D(256, 3, 3, activation='relu',
    ...
    BN7 = BatchNormalization(axis=get_axis())(conv7)
    conv7 = Convolution2D(128, 3, 3, activation='relu',
    ...
    BN8 = BatchNormalization(axis=get_axis())(conv8)
    ...
    BN9 = BatchNormalization(axis=get_axis())(conv9)
    conv9 = Convolution2D(32, 3, 3, activation='relu',
                          border_mode='same')(BN9)

    BN10 = BatchNormalization(axis=get_axis())(conv9)
