...
if __name__ == '__main__':
    ...
    train_imgs, train_masks, train_index = create_data(args.input_dirs, args.output_dir, normalization=True, reduced_size=[img_rows, img_cols], ggo_aug = 20, crop=False)
